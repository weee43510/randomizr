  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <p className="text-xs font-mono uppercase tracking-widest text-muted-foreground">30-Day Roadmap · v1</p>
      ...
      <div className="relative overflow-x-auto pb-4 -mx-2 px-2">
        <div
          ...
          style={{ background: "linear-gradient(90deg, hsl(var(--neon-green)) 0%, hsl(var(--neon-cyan)) 50%, hsla(var(--border)) 100%)" }}
        />
